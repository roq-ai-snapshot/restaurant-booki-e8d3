  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Streamlining Table Reservations and Menu Management for Restaurants, Elevating the Dining Experience for Customers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Streamlining Table Reservations and Menu Management for Restaurants, Elevating the Dining Experience for Customers`}
            </Text>
            <Box
